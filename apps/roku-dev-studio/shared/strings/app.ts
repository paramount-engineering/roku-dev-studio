...
WiFi MAC: ${d.wifiMac || 'N/A'}`,
  ...
  deviceImageNotFetched: 'Device image could not be fetched.',
  ...
  appTileTitle: (name: string, id: string): string =>
    `${name}\nID: ${id}\nClick to launch, or drag onto an App ID field`,
  ...
  tryDemoAppTitle: 'Try the bundled Roku Dev Studio Showcase demo channel',
  tryDemoAppAria: 'Try Demo App',
  tryDemoApp: 'Try Demo App',
  appMenu: 'App Menu',
  zoomOut: 'Zoom Out',
  zoomIn: 'Zoom In',
  ...
  hideDevicePerformance: 'Hide Device Performance',
  devicePerformanceToggleTitle: 'Toggle Device Performance charts',
  toggleFps: 'Toggle FPS',
  fpsToggleTitle: 'Toggle On-Screen FPS meter',
  remoteBack: 'Back',
  remoteHome: 'Home',
  ...
  memMetricsMode: 'Memory Metrics Mode',
  memModeSystem: 'System',
  memModeGraphics: 'Graphics',
  viewBitmapsTitle: 'View Graphics Bitmaps',
  viewBitmapsAria: 'View Graphics Bitmaps',
  legendTotal: 'Total',
  legendUser: 'User',
  legendKernel: 'Kernel',
  legendUsed: 'Used',
  ...
  legendSystem: 'System',
  chartInfoTitle: 'Chart Info',
  chartInfoAria: 'Chart Info',
  chartExportTitle: 'Export Chart Data',
  chartExportAria: 'Export Chart Data',
