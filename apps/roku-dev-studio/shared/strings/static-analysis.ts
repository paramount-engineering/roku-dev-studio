...
export const staticAnalysis = {
  ...
  categoryChannelStoreDesc: 'Requirements for listing on the Channel Store.',
  categoryAuthentication: 'Authentication',
  categoryAuthenticationDesc: "Checks for your channel's sign-in and account linking flows.",
  categoryBilling: 'Billing',
  categoryBillingDesc: "Checks for your channel's in-app purchase and billing flows.",
  categoryDeepLinking: 'Deep Linking',
  categoryDeepLinkingDesc: "Checks for your channel's deep linking implementation.",
  categoryAnalytics: 'Analytics',
  categoryAnalyticsDesc: 'Checks for analytics and telemetry integration.',
  categoryPerformance: 'Performance',
  categoryPerformanceDesc: 'Checks for performance-related issues in your channel.',
  categoryMonitoring: 'Monitoring',
  categoryMonitoringDesc: 'Checks for monitoring and health-check integration.',
  ...
  noFilterMatchNote: 'No issues match the current filter.',
