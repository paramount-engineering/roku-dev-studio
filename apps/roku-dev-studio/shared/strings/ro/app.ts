...
MAC WiFi: ${d.wifiMac || 'N/A'}`,
  ...
  featureConsoleDesc: 'Vezi ieșirea de depanare BrightScript prin Telnet, filtrează și caută',
  ...
  selectFunctionParamHint: 'Selectați o funcție pentru a vedea detaliile parametrilor',
  execute: 'Execută',
