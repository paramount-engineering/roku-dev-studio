...
export const app = {
  ...
  rceStart: 'Pornește',
  rceStop: 'Oprește',
  rceStarting: 'Se pornește…',
  rceWakeDevice: 'Trezește dispozitivul',
  rceDevMode: 'Mod dezvoltator',
  rceStatusOff: 'Oprit',
  rceNoStartableSnapshot: 'Nu s-a găsit niciun instantaneu sau nicio versiune de firmware utilizabilă pentru acest dispozitiv.',
  rceNoInstanceUrl: 'Dispozitivul nu are o adresă URL de instanță — mai rulează?',
  rceNoLongerRunning: 'Dispozitivul nu mai rulează.',
  rceDevPasswordRequired: 'Este necesară o parolă de dezvoltator.',

  rceStartDeviceOptions: 'Opțiuni',
  rceStartDeviceOptionsAria: 'Opțiuni de pornire a dispozitivului',
  rceStartDeviceModalTitle: (name: string): string => `Pornește dispozitivul RCE: ${name}`,
  rceStartDevice: 'Pornește dispozitivul',
  rceMaxRunTime: 'Durată maximă de rulare',
  rceMaxRunTimeHour: 'Oră',
  rceMaxRunTimeMin: 'Min',
  rceMaxRunTimeHint: 'Până la 48 de ore',
  rceFirmwareVersion: 'Versiune firmware',
  rceFirmwareSelectPlaceholder: 'Selectează firmware',
  rceFirmwareNoData: 'Fără date despre firmware',
  rceFirmwareRequired: 'Selectează o versiune de firmware.',
  rceFirmwareRetired: (id: string): string => `Firmware-ul acestui dispozitiv (${id}) nu mai este disponibil — selectează unul diferit.`,
  rceFirmwareUnavailable: (id: string): string =>
    `Firmware-ul ${id} nu mai este disponibil pentru acest dispozitiv — apasă pe meniul derulant de lângă Pornește pentru a alege altul.`,
  rceUseThisSnapshot: 'Utilizează acest instantaneu',
  rceSnapshotAria: 'Instantaneu',
  rceSnapshotSelectPlaceholder: 'Selectează instantaneu',
  rceSnapshotInitialOption: 'Instantaneu inițial',
  rceSnapshotLoadFailed: 'Nu s-au putut încărca instantaneele — se folosește valoarea implicită.',
  rceSnapshotStarted: 'Pornit',
  rceSnapshotReady: 'Pregătit',
  rceSnapshotLive: 'Live',
  rceSnapshotBase: 'Bază',

  // RCE user info modal ("User Info" button, GET /user/me)
  rceCloudEmulatorTitle: 'Roku Cloud Emulator',
  rceUserInfoTitle: 'Informații despre utilizator',
  rceUserInfoOrganization: 'Organizație',
  rceUserInfoName: 'Utilizator',
  rceUserInfoEmail: 'E-mail',
  rceUserInfoDevices: 'Dispozitive',
  rceUserInfoSnapshots: 'Instantanee',
  rceUserInfoMaxRuntime: 'Durată maximă de rulare',
  rceUserInfoDevicesValue: (used: number, max: number): string => `${used} / ${max}`,
  rceUserInfoRuntimeValue: (hours: number): string => `${hours}h`,
  rceUserInfoLoadFailed: 'Nu s-au putut încărca informațiile despre utilizator.',
  rceUserInfoLoading: 'Se încarcă informațiile despre utilizator...',

  rceUsageHeading: 'Utilizare — ultimele 7 zile',
  ...
  rceDeviceInfoTitle: 'Informații despre dispozitiv',
  rceDeviceInfoCreated: 'Creat',
  rceDeviceInfoLastSnapshot: 'Ultimul instantaneu',
  rceDeviceInfoNote: 'Notă',
  rceDeviceInfoInstanceId: 'ID instanță',
...
MAC WiFi: ${d.wifiMac || 'N/A'}`,
  ...
  deviceImageNotFetched: 'Imaginea dispozitivului nu a putut fi obținută.',
  ...
  ecpWarnLimitedDesc:
    'Telecomanda de bază și introducerea de text funcționează, dar unele interogări ale aplicațiilor și apăsarea completă a tastelor de pe telecomandă s-ar putea să nu fie disponibile — setați Network Access la <strong>Permissive</strong> sau <strong>Enabled</strong> pentru funcționalitate completă.',
  ...
  tryDemoAppTitle: 'Încearcă canalul demonstrativ inclus Roku Dev Studio Showcase',
  tryDemoAppAria: 'Încearcă aplicația demo',
  tryDemoApp: 'Încearcă Aplicația Demo',
  ...
  hideDevicePerformance: 'Ascunde performanța dispozitivului',
  devicePerformanceToggleTitle: 'Comută graficele de performanță ale dispozitivului',
  toggleFps: 'Comută FPS',
  fpsToggleTitle: 'Comută contorul FPS de pe ecran',
  remoteBack: 'Înapoi',
  remoteHome: 'Acasă',
  ...
  memMetricsMode: 'Mod metrici memorie',
  memModeSystem: 'Sistem',
  memModeGraphics: 'Grafică',
  viewBitmapsTitle: 'Vizualizare bitmapuri grafice',
  viewBitmapsAria: 'Vizualizare bitmapuri grafice',
  legendTotal: 'Total',
  ...
  run: 'Rulează',
  customQueryPlaceholder: 'ex. /query/device-info sau free',
  results: 'Rezultate',
