...
export const devApp = {
  ...
  screenshotPreviewTitle: 'Captură de ecran',

  captureSuccess: 'Capturat!',
  rceStreamNotReady: 'Fluxul video nu este încă pregătit.',
  rceVideoConnecting: 'Se conectează la fluxul video…',
  rceVideoReconnecting: 'Se reconectează la fluxul video…',
  rceVideoStopped: 'Flux video oprit — dispozitivul nu mai rulează.',
  rceVideoError: (detail: string): string => `Eroare flux video: ${detail}`,
  rceVolumeLabel: 'Volum',
  rceMuteLabel: 'Dezactivare sunet',
  rceUnmuteLabel: 'Activare sunet',
  rceDeviceScreenRelay: 'Redirecționare Ecran',
  rceGalleryButton: 'Capturi',
  rceGalleryTitle: 'Capturi din Sesiune',
  rceGalleryEmpty: 'Nu s-a capturat nicio imagine în această sesiune încă.',
  rceGalleryCapturedAt: (time: string): string => `Capturat ${time}`,
