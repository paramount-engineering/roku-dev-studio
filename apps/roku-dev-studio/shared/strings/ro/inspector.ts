...
export const inspector = {
  ...
  functionDetailsTitle: 'Detalii funcție',
  openFunctionDetails: 'Afișați detaliile funcției',
  noFunctionDetails: 'Nu există detalii disponibile pentru această funcție.',
