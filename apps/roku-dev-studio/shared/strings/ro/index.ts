/**
 * Romanian catalog — same shape as the English base (`../index.ts`), composed from
 * per-area sibling modules. Registered as the 'ro' locale in the parent index.
 */
...
// Placeholder: reuse the English "Try Demo App" strings until a Romanian translation exists.
