...
export const actionScripts = {
  ...
  saveModalNameLabel: 'Nume',
  saveModalNamePlaceholder: 'ex. Lansează și redă',
  saveModalNameRequired: 'Introduceți un nume.',
  saveModalOverwriteWarning: (name: string): string =>
    `Un script salvat cu numele "${name}" există deja.`,
  saveModalOverwriteConfirm: 'Suprascrie',
  saveModalSavedListLabel: 'Scripturi salvate',
  saveModalNoSavedScripts: 'Niciun script salvat',
  toastSaveFailed: 'Salvarea scriptului a eșuat.',
  viewerHeading: 'Vizualizează și gestionează Action Scripts',
  viewerSaveAs: 'Salvează ca…',
  viewerApplyToDevice: 'Aplică pe dispozitiv',
  viewerApply: 'Aplică',
  viewerRescan: 'Scanează din nou',
  viewerNoDevices: 'Nu s-au găsit dispozitive',
  viewerCopySuffix: 'copie',
  viewerDeleteConfirm: (name: string): string => `Ștergeți scriptul salvat „${name}”?`,
  viewerNoDeviceNote: 'Conectați un dispozitiv în fereastra principală pentru a vedea în timp real numele funcțiilor App Connector și RALE.',
  viewerEmpty: 'Încă nu există scripturi salvate — salvați unul din Builder-ul Action Scripts dintr-o filă de dispozitiv.',
