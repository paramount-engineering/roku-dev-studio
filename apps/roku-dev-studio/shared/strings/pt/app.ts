...
MAC WiFi: ${d.wifiMac || 'N/A'}`,
  ...
  featureConsoleDesc: 'Veja a saída de depuração do BrightScript via Telnet, filtre e pesquise',
  ...
  selectFunctionParamHint: 'Selecione uma função para ver os detalhes dos parâmetros',
  execute: 'Executar',
