...
export const actionScripts = {
  ...
  saveModalNameLabel: 'Nome',
  saveModalNamePlaceholder: 'ex.: Iniciar e reproduzir',
  saveModalNameRequired: 'Digite um nome.',
  saveModalOverwriteWarning: (name: string): string =>
    `Já existe um script salvo com o nome "${name}".`,
  saveModalOverwriteConfirm: 'Substituir',
  saveModalSavedListLabel: 'Scripts salvos',
  saveModalNoSavedScripts: 'Nenhum script salvo',
  toastSaveFailed: 'Falha ao salvar o script.',
  viewerHeading: 'Visualizar e gerenciar Action Scripts',
  viewerSaveAs: 'Salvar como…',
  viewerApplyToDevice: 'Aplicar ao dispositivo',
  viewerApply: 'Aplicar',
  viewerRescan: 'Escanear novamente',
  viewerNoDevices: 'Nenhum dispositivo encontrado',
  viewerCopySuffix: 'cópia',
  viewerDeleteConfirm: (name: string): string => `Excluir o script salvo "${name}"?`,
  viewerNoDeviceNote: 'Conecte um dispositivo na janela principal para ver os nomes das funções do App Connector e RALE em tempo real.',
  viewerEmpty: 'Ainda não há scripts salvos — salve um no Builder de Action Scripts em uma aba de dispositivo.',
