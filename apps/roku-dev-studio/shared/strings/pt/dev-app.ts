...
export const devApp = {
  ...
  screenshotPreviewTitle: 'Captura de tela',

  captureSuccess: 'Capturado!',
  rceStreamNotReady: 'A transmissão de vídeo ainda não está pronta.',
  rceVideoConnecting: 'Conectando à transmissão de vídeo…',
  rceVideoReconnecting: 'Reconectando à transmissão de vídeo…',
  rceVideoStopped: 'Transmissão de vídeo interrompida — o dispositivo não está mais em execução.',
  rceVideoError: (detail: string): string => `Erro na transmissão de vídeo: ${detail}`,
  rceVolumeLabel: 'Volume',
  rceMuteLabel: 'Silenciar',
  rceUnmuteLabel: 'Reativar som',
  rceDeviceScreenRelay: 'Retransmissão da Tela',
  rceGalleryButton: 'Capturas',
  rceGalleryTitle: 'Capturas da Sessão',
  rceGalleryEmpty: 'Nenhuma captura de tela feita nesta sessão ainda.',
  ...
  exportCpuDialogTitle: 'Exportar Dados de Uso da CPU',
  exportMemoryDialogTitle: 'Exportar Dados de Uso de Memória',
  exportObjectsDialogTitle: 'Exportar Dados de Objetos BrightScript',
  nothingToExportYet: 'Ainda não há nada para exportar',
  exportedTo: (filePath: string): string => `✓ Exportado para: ${filePath}`,
  exportFailed: (detail: string): string => `Falha na exportação: ${detail}`,
