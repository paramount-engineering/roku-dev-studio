...
export const modals = {
  ...
  features: {
    ...
    console: {
      blurb:
        'Транслюйте наживо вихідні дані налагодження BrightScript з Roku через Telnet, з фільтрацією та пошуком, щоб виявити саме те, що важливо.',
      points: [
        'Живий потік журналу Telnet',
        'Фільтр і повнотекстовий пошук',
        'Клацніть URL або JSON, щоб переглянути їх у модальному вікні',
