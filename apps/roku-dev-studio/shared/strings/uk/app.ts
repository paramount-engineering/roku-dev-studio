...
export const app = {
  ...
  rceStop: 'Зупинити',
  rceStarting: 'Запуск…',
  rceWakeDevice: 'Активувати пристрій',
  rceDevMode: 'Режим розробника',
  rceStatusOff: 'Вимкнено',
  rceNoStartableSnapshot: 'Не знайдено придатного знімка або версії прошивки для цього пристрою.',
  rceNoInstanceUrl: 'Пристрій не має URL-адреси інстансу — він досі запущений?',
  rceNoLongerRunning: 'Пристрій більше не запущений.',
  rceDevPasswordRequired: 'Потрібен пароль розробника.',

  rceStartDeviceOptions: 'Параметри',
  rceStartDeviceOptionsAria: 'Параметри запуску пристрою',
  rceStartDeviceModalTitle: (name: string): string => `Запустити пристрій RCE: ${name}`,
  rceStartDevice: 'Запустити пристрій',
  rceMaxRunTime: 'Максимальний час роботи',
  rceMaxRunTimeHour: 'Год',
  rceMaxRunTimeMin: 'Хв',
  rceMaxRunTimeHint: 'До 48 годин',
  rceFirmwareVersion: 'Версія прошивки',
  rceFirmwareSelectPlaceholder: 'Виберіть прошивку',
  rceFirmwareNoData: 'Немає даних про прошивку',
  rceFirmwareRequired: 'Виберіть версію прошивки.',
  rceFirmwareRetired: (id: string): string => `Прошивка цього пристрою (${id}) більше недоступна — виберіть іншу.`,
  rceFirmwareUnavailable: (id: string): string =>
    `Прошивка ${id} більше недоступна для цього пристрою — натисніть спадне меню поруч із кнопкою «Пуск», щоб вибрати іншу.`,
  rceUseThisSnapshot: 'Використати цей знімок',
  rceSnapshotAria: 'Знімок',
  rceSnapshotSelectPlaceholder: 'Вибрати знімок',
  rceSnapshotInitialOption: 'Початковий знімок',
  rceSnapshotLoadFailed: 'Не вдалося завантажити знімки — використано типове значення.',
  rceSnapshotStarted: 'Запущено',
  rceSnapshotReady: 'Готовий',
  rceSnapshotLive: 'Активний',
  rceSnapshotBase: 'Базовий',

  // RCE user info modal ("User Info" button, GET /user/me)
  rceCloudEmulatorTitle: 'Roku Cloud Emulator',
  rceUserInfoTitle: 'Інформація про користувача',
  rceUserInfoOrganization: 'Організація',
  rceUserInfoName: 'Користувач',
  rceUserInfoEmail: 'Електронна пошта',
  rceUserInfoDevices: 'Пристрої',
  rceUserInfoSnapshots: 'Знімки',
  rceUserInfoMaxRuntime: 'Максимальний час роботи',
  rceUserInfoDevicesValue: (used: number, max: number): string => `${used} / ${max}`,
  rceUserInfoRuntimeValue: (hours: number): string => `${hours}h`,
  rceUserInfoLoadFailed: 'Не вдалося завантажити інформацію про користувача.',
  rceUserInfoLoading: 'Завантаження інформації про користувача...',

  rceUsageHeading: 'Використання — останні 7 днів',
  ...
  rceDeviceInfoTitle: 'Інформація про пристрій',
  rceDeviceInfoCreated: 'Створено',
  rceDeviceInfoLastSnapshot: 'Останній знімок',
  rceDeviceInfoNote: 'Примітка',
  rceDeviceInfoInstanceId: 'ID екземпляра',
...
WiFi MAC: ${d.wifiMac || 'Н/Д'}`,
  ...
  deviceImageNotFetched: 'Не вдалося отримати зображення пристрою.',
  ...
  ecpWarnLimitedDesc:
    'Базовий пульт і введення тексту працюють, але деякі запити застосунків і повне натискання клавіш пульта можуть бути недоступні — встановіть «Доступ до мережі» на <strong>Permissive</strong> або <strong>Enabled</strong> для повної функціональності.',
  ...
  hideDevicePerformance: 'Приховати продуктивність пристрою',
  devicePerformanceToggleTitle: 'Перемкнути графіки продуктивності пристрою',
  toggleFps: 'Перемкнути FPS',
  fpsToggleTitle: 'Перемкнути лічильник FPS на екрані',
  remoteBack: 'Назад',
  remoteHome: 'Головна',
  remoteOptions: 'Опції',
  remoteReplay: 'Повтор',
  ...
  memMetricsMode: 'Режим метрик пам’яті',
  memModeSystem: 'Система',
  memModeGraphics: 'Графіка',
  viewBitmapsTitle: 'Переглянути бітмапи графіки',
  viewBitmapsAria: 'Переглянути бітмапи графіки',
  legendTotal: 'Усього',
  ...
  deeplinkParamKeyPlaceholder: 'Ключ',
  deeplinkParamValuePlaceholder: 'Значення',
  removeParameter: 'Видалити параметр',
  listApps: 'Список',
  ...
  run: 'Запустити',
  customQueryPlaceholder: 'напр. /query/device-info або free',
  results: 'Результати',
  ...
  saveToDirectory: 'Зберегти в папку…',
  moreSaveOptions: 'Більше параметрів збереження',
