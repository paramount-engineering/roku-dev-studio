...
export const devApp = {
  ...
  screenshotPreviewTitle: 'Знімок екрана',

  captureSuccess: 'Знято!',
  rceStreamNotReady: 'Відеопотік ще не готовий.',
  rceVideoConnecting: 'Підключення до відеопотоку…',
  rceVideoReconnecting: 'Повторне підключення до відеопотоку…',
  rceVideoStopped: 'Відеопотік зупинено — пристрій більше не запущений.',
  rceVideoError: (detail: string): string => `Помилка відеопотоку: ${detail}`,
  rceVolumeLabel: 'Гучність',
  rceMuteLabel: 'Вимкнути звук',
  rceUnmuteLabel: 'Увімкнути звук',
  rceDeviceScreenRelay: 'Трансляція Екрана',
  rceGalleryButton: 'Знімки',
  rceGalleryTitle: 'Знімки Сесії',
  rceGalleryEmpty: 'У цій сесії ще не зроблено жодного знімка.',
  rceGalleryCapturedAt: (time: string): string => `Знято ${time}`,
