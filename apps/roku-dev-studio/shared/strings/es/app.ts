...
MAC de WiFi: ${d.wifiMac || 'N/D'}`,
  ...
  featureConsoleDesc: 'Vea la salida de depuración de BrightScript mediante Telnet, filtre y busque',
  ...
  selectFunctionParamHint: 'Seleccione una función para ver los detalles de los parámetros',
  execute: 'Ejecutar',
