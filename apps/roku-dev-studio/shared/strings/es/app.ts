...
export const app = {
  ...
  rceWakeDevice: 'Activar dispositivo',
  rceDevMode: 'Modo desarrollador',
  rceStatusOff: 'Apagado',
  rceNoStartableSnapshot: 'No se encontró una instantánea o versión de firmware utilizable para este dispositivo.',
  rceNoInstanceUrl: 'El dispositivo no tiene una URL de instancia. ¿Sigue en ejecución?',
  rceNoLongerRunning: 'El dispositivo ya no está en ejecución.',
  rceDevPasswordRequired: 'Se requiere una contraseña de desarrollador.',

  rceStartDeviceOptions: 'Opciones',
  rceStartDeviceOptionsAria: 'Opciones de inicio del dispositivo',
  rceStartDeviceModalTitle: (name: string): string => `Iniciar dispositivo RCE: ${name}`,
  rceStartDevice: 'Iniciar dispositivo',
  rceMaxRunTime: 'Tiempo máximo de ejecución',
  rceMaxRunTimeHour: 'Hora',
  rceMaxRunTimeMin: 'Min',
  rceMaxRunTimeHint: 'Hasta 48 horas',
  rceFirmwareVersion: 'Versión de firmware',
  rceFirmwareSelectPlaceholder: 'Seleccionar firmware',
  rceFirmwareNoData: 'Sin datos de firmware',
  rceFirmwareRequired: 'Selecciona una versión de firmware.',
  rceFirmwareRetired: (id: string): string => `El firmware de este dispositivo (${id}) ya no está disponible — selecciona uno diferente.`,
  rceFirmwareUnavailable: (id: string): string =>
    `El firmware ${id} ya no está disponible para este dispositivo — haz clic en el menú desplegable junto a Iniciar para elegir otro.`,
  rceUseThisSnapshot: 'Usar esta instantánea',
  rceSnapshotAria: 'Instantánea',
  rceSnapshotSelectPlaceholder: 'Seleccionar instantánea',
  rceSnapshotInitialOption: 'Instantánea inicial',
  rceSnapshotLoadFailed: 'No se pudieron cargar las instantáneas — usando el valor predeterminado.',
  rceSnapshotStarted: 'Iniciada',
  rceSnapshotReady: 'Lista',
  rceSnapshotLive: 'En vivo',
  rceSnapshotBase: 'Base',

  // RCE user info modal ("User Info" button, GET /user/me)
  rceCloudEmulatorTitle: 'Roku Cloud Emulator',
  rceUserInfoTitle: 'Información del usuario',
  rceUserInfoOrganization: 'Organización',
  rceUserInfoName: 'Usuario',
  rceUserInfoEmail: 'Correo electrónico',
  rceUserInfoDevices: 'Dispositivos',
  rceUserInfoSnapshots: 'Instantáneas',
  rceUserInfoMaxRuntime: 'Tiempo de ejecución máximo',
  rceUserInfoDevicesValue: (used: number, max: number): string => `${used} / ${max}`,
  rceUserInfoRuntimeValue: (hours: number): string => `${hours}h`,
  rceUserInfoLoadFailed: 'No se pudo cargar la información del usuario.',
  rceUserInfoLoading: 'Cargando información del usuario...',

  rceUsageHeading: 'Uso — últimos 7 días',
  ...
  rceDeviceInfoTitle: 'Información del dispositivo',
  rceDeviceInfoCreated: 'Creado',
  rceDeviceInfoLastSnapshot: 'Última instantánea',
  rceDeviceInfoNote: 'Nota',
  rceDeviceInfoInstanceId: 'ID de instancia',
...
MAC de WiFi: ${d.wifiMac || 'N/D'}`,
  ...
  deviceImageNotFetched: 'No se pudo obtener la imagen del dispositivo.',
  ...
  deviceInfoPanelTitle: 'Información del dispositivo',
  deviceInfoUnavailable: 'Información del dispositivo no disponible.',
  networkTypeWifi: 'Wi-Fi',
  networkTypeEthernet: 'Ethernet',
  refreshDeviceInfo: 'Actualizar información del dispositivo',
  ...
  ecpWarnLimitedDesc:
    'El control remoto básico y la entrada de texto funcionan, pero algunas consultas de apps y la pulsación completa de teclas del control remoto quizás no estén disponibles; configure Network Access en <strong>Permissive</strong> o <strong>Enabled</strong> para la funcionalidad completa.',
  ...
  featureConsoleDesc: 'Vea la salida de depuración de BrightScript mediante Telnet y otros puertos del dispositivo.',
  ...
  featureRemoteLocationsDesc: 'Conéctese a dispositivos Roku mediante servidores relay o un Roku Cloud Emulator.',
  ...
  hideDevicePerformance: 'Ocultar rendimiento del dispositivo',
  devicePerformanceToggleTitle: 'Alternar los gráficos de rendimiento del dispositivo',
  toggleFps: 'Alternar FPS',
  fpsToggleTitle: 'Alternar el medidor de FPS en pantalla',
  remoteBack: 'Atrás',
  remoteHome: 'Inicio',
  ...
  memMetricsMode: 'Modo de métricas de memoria',
  ...
  run: 'Ejecutar',
  customQueryPlaceholder: 'p. ej. /query/device-info o free',
  results: 'Resultados',
