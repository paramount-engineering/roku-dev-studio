...
export const settings = {
  ...
  mcpToolsButton: 'Ver herramientas MCP',
  mcpToolsModalTitle: 'Herramientas MCP',
  mcpToolsModalAria: 'Herramientas MCP expuestas a agentes de IA',
  mcpToolsIntro: (count: number): string =>
    `Las ${count} herramientas que Roku Dev Studio expone a agentes de IA mediante el Model Context Protocol, agrupadas por área.`,
  mcpToolCategories: {
    discovery: 'Conexión y detección de dispositivos',
    remote: 'Control remoto y ECP',
    sideload: 'Carga lateral (sideload)',
    telnet: 'Telnet y consola',
    appConnector: 'App Connector y RALE',
    debugger: 'Depurador',
    networkInspector: 'Inspector de red',
    actionScripts: 'Scripts de acción',
  },
  mcpToolDescriptions: {
    probe_bridge: 'Comprobar si Roku Dev Studio está en ejecución y accesible.',
    scan_devices: 'Descubrir dispositivos Roku en la red local (SSDP + barrido de subred opcional).',
    list_devices: 'Listar todos los dispositivos que Dev Studio ya conoce: conectados, descubiertos o recordados.',
    connect_device: 'Abrir o enfocar una pestaña de Dev Studio para un dispositivo dado.',
    test_connection: 'Probar la accesibilidad ECP de una IP de dispositivo.',
    get_selected_device: 'Devolver la pestaña de dispositivo actualmente enfocada en Dev Studio.',
    keypress: 'Enviar una tecla remota ECP (Arriba / Abajo / Seleccionar / Inicio / Reproducir / …).',
    input_text: 'Escribir texto literal en el campo de entrada actualmente enfocado.',
    launch_app: 'Iniciar un canal en su pantalla de inicio.',
    deep_link: 'Iniciar un canal directamente en un contenido específico mediante un enlace profundo ECP.',
    ecp_query: 'Ejecutar un GET ECP de solo lectura: información del dispositivo, apps instaladas, app activa, estado del reproductor, …',
    ecp_post: 'Enviar un POST a un endpoint ECP arbitrario (con efectos secundarios).',
    screenshot: 'Capturar la pantalla actual del dispositivo, devuelta en línea como una imagen.',
    get_app_icon: 'Obtener el icono de un canal.',
    device_performance_metrics: 'Datos de series temporales de CPU / Memoria / Objetos BrightScript durante un período solicitado, con una leyenda de decodificación.',
    sideload: 'Subir e instalar un paquete .zip del canal, reemplazando cualquier Dev App actual.',
    delete_sideload: 'Eliminar la Dev App actualmente cargada por sideload.',
    telnet_connect: 'Abrir la consola de depuración BrightScript (puerto 8085).',
    telnet_disconnect: 'Cerrar la consola de depuración BrightScript.',
    get_telnet_log: 'Leer las líneas de consola acumuladas en el búfer desde la conexión.',
    console_monitor_findings: 'Analizar el búfer de la consola para detectar problemas y fallos reconocidos de BrightScript.',
    app_connector_connect: 'Abrir una sesión RALE / App Connector contra la Dev App en ejecución.',
    app_connector_disconnect: 'Cerrar la sesión RALE / App Connector.',
    app_function: 'Invocar una función expuesta por el canal a través del App Connector.',
    list_app_connector_functions: 'Listar las funciones RALE disponibles del canal en ejecución y sus parámetros.',
    rale_command: 'Ejecutar cualquier comando integrado de RALE, incluidas operaciones destructivas del registro.',
    rale_get_node_by_id: 'Obtención de solo lectura de un nodo SceneGraph por su id.',
    debugger_attach: 'Abrir una sesión de depuración de BrightScript (el canal debe haberse iniciado con depuración).',
    debugger_status: 'Devolver el estado de la sesión sin bloquear.',
    debugger_set_breakpoints: 'Agregar puntos de interrupción — se registran de inmediato si está detenido.',
    debugger_list_breakpoints: 'Listar los puntos de interrupción registrados y su estado verificado / en cola.',
    debugger_remove_breakpoints: 'Eliminar puntos de interrupción por archivo y línea.',
    debugger_pause: 'Solicitar la detención de un canal en ejecución.',
    debugger_continue: 'Reanudar la ejecución desde un estado detenido.',
    debugger_step: 'Ejecutar paso a paso el hilo detenido (over / in / out).',
    debugger_wait_for_stop: 'Bloquear hasta la siguiente detención, devolviendo una instantánea completa.',
    debugger_get_callstack: 'Devolver los marcos de la pila de llamadas del hilo detenido.',
    debugger_get_variables: 'Devolver las variables en el ámbito de un marco de la pila.',
    debugger_evaluate: 'Ejecutar una expresión de BrightScript en el marco detenido (REPL).',
    debugger_detach: 'Cerrar la sesión de depuración.',
    network_inspector_status: 'Informar el estado de captura / MITM y los requisitos previos de configuración.',
    network_inspector_list_events: 'Listar los eventos de red capturados como resúmenes ligeros y filtrables.',
    network_inspector_get_event_detail: 'Obtener los encabezados y el cuerpo completos de un evento capturado.',
    network_inspector_find: 'Búsqueda de texto completo en las URL, encabezados y cuerpos capturados.',
    network_inspector_analyze: 'Agregar el búfer en puntos calientes y resúmenes: estado, hosts, tipos de contenido.',
    network_inspector_get_ca_info: 'Devolver la huella digital de la CA MITM y la información del proxy para descifrar HTTPS.',
    list_action_types: 'Listar todos los tipos de paso de Action Script admitidos.',
    get_action_schema: 'Devolver el esquema de autoría de un tipo de paso.',
    get_capability_bundle: 'Un único payload con todas las capacidades estáticas: acciones, vocabulario, ajustes predefinidos, contrato de autoría.',
    validate_script: 'Validar un Action Script de varios pasos antes de enviarlo al generador.',
    send_script_to_builder: 'Enviar un Action Script validado al Dev Studio Builder para su revisión.',
  },
