...
export const inspector = {
  ...
  functionDetailsTitle: 'Detalles de la función',
  openFunctionDetails: 'Mostrar detalles de la función',
  noFunctionDetails: 'No hay detalles disponibles para esta función.',
