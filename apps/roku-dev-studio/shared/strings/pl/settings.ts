...
export const settings = {
  ...
  mcpToolsButton: 'Zobacz narzędzia MCP',
  mcpToolsModalTitle: 'Narzędzia MCP',
  mcpToolsModalAria: 'Narzędzia MCP udostępnione agentom AI',
  mcpToolsIntro: (count: number): string =>
    `${count} narzędzi, które Roku Dev Studio udostępnia agentom AI przez Model Context Protocol, pogrupowanych według obszaru.`,
  mcpToolCategories: {
    discovery: 'Połączenie i wykrywanie urządzeń',
    remote: 'Zdalne sterowanie i ECP',
    sideload: 'Sideload',
    telnet: 'Telnet i konsola',
    appConnector: 'App Connector i RALE',
    debugger: 'Debugger',
    networkInspector: 'Inspektor sieci',
    actionScripts: 'Skrypty akcji',
  },
  mcpToolDescriptions: {
    probe_bridge: 'Sprawdź, czy sam Roku Dev Studio jest uruchomiony i dostępny.',
    scan_devices: 'Wykryj urządzenia Roku w sieci lokalnej (SSDP + opcjonalne skanowanie podsieci).',
    list_devices: 'Wypisz wszystkie urządzenia, które Dev Studio już zna — połączone, wykryte lub zapamiętane.',
    connect_device: 'Otwórz lub przełącz się na kartę Dev Studio dla danego urządzenia.',
    test_connection: 'Sprawdź dostępność ECP dla jednego adresu IP urządzenia.',
    get_selected_device: 'Zwróć kartę urządzenia aktualnie aktywną w Dev Studio.',
    keypress: 'Wyślij jeden klawisz zdalny ECP (Górę / Dół / Wybierz / Ekran główny / Odtwórz / …).',
    input_text: 'Wpisz zwykły tekst w aktualnie aktywnym polu wejściowym.',
    launch_app: 'Uruchom kanał na jego ekranie głównym.',
    deep_link: 'Uruchom kanał od razu na konkretnej treści za pomocą głębokiego linku ECP.',
    ecp_query: 'Wykonaj tylko-do-odczytu GET ECP — informacje o urządzeniu, zainstalowane aplikacje, aktywna aplikacja, stan odtwarzacza, …',
    ecp_post: 'Wykonaj POST na dowolny punkt końcowy ECP (ze skutkami).',
    screenshot: 'Przechwyć aktualny ekran urządzenia, zwrócony w treści jako obraz.',
    get_app_icon: 'Pobierz ikonę aplikacji kanału.',
    device_performance_metrics: 'Dane szeregów czasowych CPU / Pamięci / Obiektów BrightScript w żądanym okresie, z legendą dekodującą.',
    sideload: 'Wgraj i zainstaluj pakiet .zip kanału, zastępując bieżącą Dev App.',
    delete_sideload: 'Usuń aktualnie wgraną (sideload) Dev App.',
    telnet_connect: 'Otwórz konsolę debugowania BrightScript (port 8085).',
    telnet_disconnect: 'Zamknij konsolę debugowania BrightScript.',
    get_telnet_log: 'Odczytaj zbuforowane linie konsoli zebrane od momentu połączenia.',
    console_monitor_findings: 'Przeanalizuj bufor konsoli w poszukiwaniu rozpoznanych problemów i awarii BrightScript.',
    app_connector_connect: 'Otwórz sesję RALE / App Connector względem działającej Dev App.',
    app_connector_disconnect: 'Zamknij sesję RALE / App Connector.',
    app_function: 'Wywołaj jedną funkcję udostępnioną przez kanał za pomocą App Connector.',
    list_app_connector_functions: 'Wypisz dostępne funkcje RALE działającego kanału i ich parametry.',
    rale_command: 'Wykonaj dowolną wbudowaną komendę RALE, łącznie z destrukcyjnymi operacjami na rejestrze.',
    rale_get_node_by_id: 'Odczyt tylko-do-odczytu jednego węzła SceneGraph po id.',
    debugger_attach: 'Otwórz sesję debugowania BrightScript (kanał musi być uruchomiony z debugowaniem).',
    debugger_status: 'Zwróć stan sesji bez blokowania.',
    debugger_set_breakpoints: 'Dodaj pułapki (breakpointy) — rejestrują się natychmiast, jeśli zatrzymano.',
    debugger_list_breakpoints: 'Wypisz śledzone pułapki i ich stan (zweryfikowany / w kolejce).',
    debugger_remove_breakpoints: 'Usuń pułapki według pliku i linii.',
    debugger_pause: 'Poproś o zatrzymanie działającego kanału.',
    debugger_continue: 'Wznów wykonywanie z zatrzymanego stanu.',
    debugger_step: 'Wykonaj krok po kroku zatrzymany wątek (over / in / out).',
    debugger_wait_for_stop: 'Blokuj do następnego zatrzymania, zwracając pełny zrzut stanu.',
    debugger_get_callstack: 'Zwróć ramki stosu wywołań dla zatrzymanego wątku.',
    debugger_get_variables: 'Zwróć zmienne w zakresie danej ramki stosu.',
    debugger_evaluate: 'Wykonaj wyrażenie BrightScript w zatrzymanej ramce (REPL).',
    debugger_detach: 'Zamknij sesję debugowania.',
    network_inspector_status: 'Zgłoś stan przechwytywania / MITM oraz wymagania konfiguracyjne.',
    network_inspector_list_events: 'Wypisz przechwycone zdarzenia sieciowe jako lekkie, filtrowalne podsumowania.',
    network_inspector_get_event_detail: 'Pobierz pełne nagłówki i treść jednego przechwyconego zdarzenia.',
    network_inspector_find: 'Pełnotekstowe wyszukiwanie w przechwyconych adresach URL, nagłówkach i treściach.',
    network_inspector_analyze: 'Zagreguj bufor w hotspoty i podsumowania — status, hosty, typy treści.',
    network_inspector_get_ca_info: 'Zwróć odcisk CA MITM i informacje o proxy do odszyfrowywania HTTPS.',
    list_action_types: 'Wypisz wszystkie obsługiwane typy kroków Action Script.',
    get_action_schema: 'Zwróć schemat autorski dla jednego typu kroku.',
    get_capability_bundle: 'Jeden pakiet ze wszystkimi statycznymi możliwościami — akcje, słownik, ustawienia domyślne, kontrakt autorski.',
    validate_script: 'Zweryfikuj wieloetapowy Action Script przed wysłaniem go do buildera.',
    send_script_to_builder: 'Wyślij zweryfikowany Action Script do Dev Studio Buildera do przeglądu.',
  },
