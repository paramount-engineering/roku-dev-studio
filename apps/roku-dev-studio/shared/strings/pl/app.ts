...
export const app = {
  ...
  rceStart: 'Uruchom',
  rceStop: 'Zatrzymaj',
  rceStarting: 'Uruchamianie…',
  rceWakeDevice: 'Wybudź urządzenie',
  rceDevMode: 'Tryb deweloperski',
  rceStatusOff: 'Wyłączony',
  rceNoStartableSnapshot: 'Nie znaleziono użytecznego zrzutu ani wersji oprogramowania układowego dla tego urządzenia.',
  rceNoInstanceUrl: 'Urządzenie nie ma adresu URL instancji — czy nadal działa?',
  rceNoLongerRunning: 'Urządzenie już nie działa.',
  rceDevPasswordRequired: 'Wymagane jest hasło deweloperskie.',

  rceStartDeviceOptions: 'Opcje',
  rceStartDeviceOptionsAria: 'Opcje uruchamiania urządzenia',
  rceStartDeviceModalTitle: (name: string): string => `Uruchom urządzenie RCE: ${name}`,
  rceStartDevice: 'Uruchom urządzenie',
  rceMaxRunTime: 'Maksymalny czas działania',
  rceMaxRunTimeHour: 'Godz.',
  rceMaxRunTimeMin: 'Min',
  rceMaxRunTimeHint: 'Do 48 godzin',
  rceFirmwareVersion: 'Wersja oprogramowania układowego',
  rceFirmwareSelectPlaceholder: 'Wybierz oprogramowanie układowe',
  rceFirmwareNoData: 'Brak danych o oprogramowaniu układowym',
  rceFirmwareRequired: 'Wybierz wersję oprogramowania układowego.',
  rceFirmwareRetired: (id: string): string => `Oprogramowanie układowe tego urządzenia (${id}) nie jest już dostępne — wybierz inne.`,
  rceFirmwareUnavailable: (id: string): string =>
    `Oprogramowanie układowe ${id} nie jest już dostępne dla tego urządzenia — kliknij menu rozwijane obok przycisku Uruchom, aby wybrać inne.`,
  rceUseThisSnapshot: 'Użyj tej migawki',
  rceSnapshotAria: 'Migawka',
  rceSnapshotSelectPlaceholder: 'Wybierz migawkę',
  rceSnapshotInitialOption: 'Migawka początkowa',
  rceSnapshotLoadFailed: 'Nie udało się załadować migawek — użyto ustawień domyślnych.',
  rceSnapshotStarted: 'Uruchomiono',
  rceSnapshotReady: 'Gotowa',
  rceSnapshotLive: 'Aktywna',
  rceSnapshotBase: 'Bazowa',

  // RCE user info modal ("User Info" button, GET /user/me)
  rceCloudEmulatorTitle: 'Roku Cloud Emulator',
  rceUserInfoTitle: 'Informacje o użytkowniku',
  rceUserInfoOrganization: 'Organizacja',
  rceUserInfoName: 'Użytkownik',
  rceUserInfoEmail: 'E-mail',
  rceUserInfoDevices: 'Urządzenia',
  rceUserInfoSnapshots: 'Migawki',
  rceUserInfoMaxRuntime: 'Maksymalny czas działania',
  rceUserInfoDevicesValue: (used: number, max: number): string => `${used} / ${max}`,
  rceUserInfoRuntimeValue: (hours: number): string => `${hours}h`,
  rceUserInfoLoadFailed: 'Nie udało się załadować informacji o użytkowniku.',
  rceUserInfoLoading: 'Ładowanie informacji o użytkowniku...',

  rceUsageHeading: 'Użycie — ostatnie 7 dni',
  ...
  rceDeviceInfoTitle: 'Informacje o urządzeniu',
  rceDeviceInfoCreated: 'Utworzono',
  rceDeviceInfoLastSnapshot: 'Ostatnia migawka',
  rceDeviceInfoNote: 'Notatka',
  rceDeviceInfoInstanceId: 'ID instancji',
  ...
  labelSw: 'SW',
  labelStatus: 'Status',
  labelFirmware: 'Oprogramowanie układowe',
  labelSnapshots: 'Migawki',
  expand: 'Rozwiń',
  minimize: 'Zwiń',
...
WiFi MAC: ${d.wifiMac || 'N/D'}`,
  ...
  deviceImageNotFetched: 'Nie udało się pobrać obrazu urządzenia.',
  ...
  deviceInfoPanelTitle: 'Informacje o urządzeniu',
  deviceInfoUnavailable: 'Informacje o urządzeniu są niedostępne.',
  networkTypeWifi: 'Wi-Fi',
  networkTypeEthernet: 'Ethernet',
  refreshDeviceInfo: 'Odśwież informacje o urządzeniu',
  ...
  ecpWarnLimitedDesc:
    'Podstawowy pilot i wprowadzanie tekstu działają, ale niektóre zapytania do aplikacji i pełna obsługa klawiszy pilota mogą być niedostępne — ustaw Network Access na <strong>Permissive</strong> lub <strong>Enabled</strong>, aby uzyskać pełną funkcjonalność.',
  ...
  hideDevicePerformance: 'Ukryj wydajność urządzenia',
  devicePerformanceToggleTitle: 'Przełącz wykresy wydajności urządzenia',
  toggleFps: 'Przełącz FPS',
  fpsToggleTitle: 'Przełącz licznik FPS na ekranie',
  remoteBack: 'Wstecz',
  ...
  memMetricsMode: 'Tryb metryk pamięci',
  memModeSystem: 'System',
  memModeGraphics: 'Grafika',
  viewBitmapsTitle: 'Wyświetl bitmapy grafiki',
  viewBitmapsAria: 'Wyświetl bitmapy grafiki',
  legendTotal: 'Łącznie',
  ...
  run: 'Uruchom',
  customQueryPlaceholder: 'np. /query/device-info lub free',
  results: 'Wyniki',
