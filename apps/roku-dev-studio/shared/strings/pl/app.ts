...
WiFi MAC: ${d.wifiMac || 'N/D'}`,
  ...
  featureConsoleDesc: 'Wyświetlaj dane debugowania BrightScript przez Telnet, filtruj i wyszukuj',
  ...
  selectFunctionParamHint: 'Wybierz funkcję, aby zobaczyć szczegóły parametrów',
  execute: 'Wykonaj',
